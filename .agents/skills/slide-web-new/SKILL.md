---
name: slide-web-new
description: Use when creating high-quality HTML presentation slides — proposals, pitches, academic presentations, product overviews, internal meeting decks, or workshop materials. Output is a single reveal.js HTML file (browser-viewable, full-screen, PDF-exportable). Use slide-web-new when design quality and layout freedom matter. Use slide-gen when the recipient needs an editable PowerPoint.
---
